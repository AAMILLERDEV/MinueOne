...
import UserNotRegisteredError from '@/components/UserNotRegisteredErrors';
...
const AuthenticatedApp = () => {
  ...
  // Always render routes so /login is reachable.
  // The useEffect above redirects unauthenticated users away from protected pages.
  return (
    <Routes>
      <Route path="/" element={
